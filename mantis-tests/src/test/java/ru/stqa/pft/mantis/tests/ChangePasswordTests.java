...
public class ChangePasswordTests extends TestBase {
  ...
  @Test
  public void testChangePassword() throws IOException, MessagingException, com.sun.xml.internal.messaging.saaj.packaging.mime.MessagingException {
    app.changePasswordHelper().adminLogin("administrator", "root");
